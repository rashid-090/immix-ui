...
import { abtbg, Tab1, Tab2 } from "../assets";
...
const tabData = [
  {
    ...
    image: Tab1,
    description:
      "Our remote infrastructure management services provide end-to-end monitoring and management of IT systems from any location, ensuring seamless operations and minimal downtime.",
    points: [
  ...
  //   description:
  //     "Our managed hosting services offer tailored server solutions to meet your business needs, ensuring reliability, security, and performance. Key features include.",
  //   points: [
  ...
  // },
  {
    ...
    image: Tab2, // Replace with specific image if available
    description:
      "Our Infrastructure as a Service (IaaS) solutions provide scalable virtual computing resources over the internet, enabling businesses to leverage cloud computing without the burden of managing physical hardware. Key benefits include:",
    points: [
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="h-full flex flex-col justify-center p-5 md:p-10">
              ...
              <div className="mt-8 text-sm flex flex-col gap-3">
